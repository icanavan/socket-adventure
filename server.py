...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    game_name = "little memory of the last week."
    ...
    def room_description(self, room_number):
        ...
        # TODO: YOUR CODE HERE
        return [
            "You are in the depths of Castle Gormenghast, with rain pouring through cracks in the neglected ceiling. When the mysterious cries cease to echo through the castle's once hallowed hallways, the faint sound of Swelter's kitchen staff can be heard.",
            "The cries get louder until you are confronted with an ancient  wooden door. Granite walls glistening with water help your torch illuminate that the key appears to have rusted and broken off in the lock. The door will not budge, and the cacophany persists.",
            "Abbiatas Swelter looms in the center of the kitchen like no man you've seen before. Perched on a barrel of the castle's finest cordial, the great pink mountain of flesh wearing a comically large chef's hat booms orders to his exhausted staff.",
            "You are standing in a sea of flagstones under the whorling sky. The wind howls and your hair whips round your face as stinging rain hits your cheeks. Though only the edge of Gormenghast Forest can be seen past the pouring rain, you stare into the abyss of the valley below."
            ][room_number]
    ...
    def greet(self):
        ...
        :return: None
        """
        self.output_buffer = "You awaken on a tattered rug, with {} {}".format(
            self.game_name,
    ...
    def quit(self, argument):
        ...
        self.done = True
        self.output_buffer = "Fare thee well"
    ...
    def push_output(self):
        ...
        self.client_connection.sendall(b"Time passes, and the storm continues." + self.output_buffer.encode() + b"\n")
